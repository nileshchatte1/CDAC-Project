                    ...
                    <div className="position1">
                         <div className="dropdown">
                             ...
                             <ul className="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                 <li><a className="dropdown-item" onClick={() => { this.selectCredit()}}>Cash on Delivery</a></li>
                             </ul>
                         </div>     
                     </div> 
                     <br/>  

                    <button className="btn4 btn-primary" style={{width:'150px'}} onClick={() => this.payment()}>Place Order</button>
                </div>
                </div>
            </div>
            </div>

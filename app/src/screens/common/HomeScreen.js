    ...
    render() {
        return (
            <div>
                    ...
                    <table>
                        <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel" >
                               ...
                               <div className="carousel-inner" >
                                    ...
                                    <Link to="/home">
                                    <img src="https://www.jiomart.com/images/cms/aw_rbslider/slides/1630599741_w.jpg" className="d-block w-100 " alt="image1" />
                                    </Link>
                                    </div>
                                    <div className="carousel-item" data-bs-interval="2000">
                                    <img src="https://www.jiomart.com/images/cms/aw_rbslider/slides/1630417111_gmw.jpg" className="d-block w-100 " alt="image2"/>
                                    </div>
                                    <div className="carousel-item" data-bs-interval="2000">
                                    <img src="https://www.jiomart.com/images/cms/aw_rbslider/slides/1630421633_pw.jpg" className="d-block w-100 " alt="image3" />
                                    </div>
                                    <div className="carousel-item" data-bs-interval="2000">
                                    <img src="https://www.jiomart.com/images/cms/aw_rbslider/slides/1630656956_mumbai1.jpg" className="d-block w-100 " alt="image4" />
                                    </div>
                                    <div className="carousel-item" data-bs-interval="2000">
                                    <img src="https://www.jiomart.com/images/cms/aw_rbslider/slides/1630416105_healthweb.jpg" className="d-block w-100 " alt="image5" />
                                    </div>
                ...
                <img src="https://www.jiomart.com/images/cms/aw_rbslider/slides/1629735527_web.jpg" style={{width: "100%"}}></img>
                ...
                <div className="container">
                    ...
                    {this.state.category.map(cat => 
                        <div className="product col-md-3" key={cat.id}>
                            ...
                            <a className="navbar-brand" name="fruitsnvegetables" onClick={() => { this.selectcategory(cat.id, cat.categoryName) }}>

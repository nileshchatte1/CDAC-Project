...
const TermAndConditionScreen = () => {
    return (
        <div>
            ...
            <p>Grocery Mart is the licensed owner of the brand grocerymart.in 
                and the website grocerymart.in (”The Site”).Grocery Mart
                 respects your privacy. This Privacy Policy provides succinctly 
                 the manner your data is collected and used by Grocery Mart on 
                 ...
                 use of your data by Grocery Mart in the manner provided in this 
                 Privacy Policy.
            </p>
            <br/>
            <h5>Services overview
</h5>
            <p>As part of the registration process on the Site, Grocery Mart 
            ...
            <br/>
            <h5>Eligibility</h5>
            <p>Services of the Site would be available to only select geographies 
                in India and abroad. Persons who are “incompetent to contract” 
                ...
                Terms of Use. If your age is below 18 years your parents or legal 
                guardians can transact on behalf of you if they are registered 
                users. You are prohibited from purchasing any material which is 
                for adult consumption and the sale of which to minors is 
                prohibited
</p>
            <br/>
            <h5>License & Site access
</h5>
            <p>Grocery Mart grants you a limited sub-license to access and make 
                ...
                written consent of Grocery Mart. This license does not include 
                ...
                another merchant; or any use of data mining, robots, or similar 
                ...
                express written consent of Grocery Mart. You may not frame or utilize 
                ...
                of Grocery Mart and its affiliates without express written consent. 
                You may not use any meta tags or any other “hidden text” utilizing the 
                Site’s or Grocery Mart’s name or MGM’s name or trademarks without the 
                express written consent of Grocery Mart. Any unauthorized use terminates 
                the permission or license granted by Grocery Mart</p>
            <br/>
        </div>
        </div>
    );
